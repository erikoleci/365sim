...
// Exported so MatchDetail/LivePitch can show the exact same per-second
// ticking clock as the match list, instead of freezing between their own
// (slower) 15s polling refreshes.
